...
export function SidebarMenu() {
    ...
    if (item.children) {
      ...
      return (
        <AccordionMenuItem
          key={index}
          value={item.path || ''}
          className="text-sm font-medium p-2 h-10"
        >
  ...
  return (
    <div
      className={cn(
        'kt-scrollable-y-hover flex grow shrink-0 transition-all duration-300',
        settings.layouts.demo1.sidebarCollapse ? 'py-2 px-2' : 'py-6 px-6',
