...
export function ModalAtolKassa({ open, onOpenChange }: IModalProfileProps) {
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-6">
          ...
          <div className="w-full max-w-full flex flex-col">
            <Input label="ID группы ККТ" className="w-full max-w-full" />
            <span className="text-[10px] text-[#99A1B7] tracking-tight">
              Подсказка-описание поля ввода
            </span>
          </div>

          <div className="flex gap-6 flex-wrap">
            <div className="grow-1 basis-[200px] w-full flex flex-col ">
              <Input label="Ваш логин в АТОЛ" className=" w-full" />
              <span className="text-[10px] text-[#99A1B7] tracking-tight">
                от выбранной кассы
              </span>
            </div>
