...
export function ModalEComKassa({ open, onOpenChange }: IModalProfileProps) {
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-6">
          ...
          <div className="w-full max-w-full flex flex-col">
            <Input label="ID группы KKT" className="w-full max-w-full" />
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="grow-1 basis-[200px] w-full flex flex-col ">
              <Input label="Ваш логин в E-COM касса" className=" w-full" />
              <span className="text-[10px] text-[#99A1B7] tracking-tight">
                от выбранной кассы
              </span>
            </div>
            <div className="grow-1 basis-[200px] w-full flex flex-col ">
              <Input
                label="Ваш пароль в E-COM касса"
                className="w-full"
