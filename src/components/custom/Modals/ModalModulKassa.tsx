...
export function ModalModulKassa({ open, onOpenChange }: IModalProfileProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="p-4 flex flex-col gap-6">
          ...
          <ModalAlert>
            <span>
              Обратите внимание, что касса работает c ФФД 1.05.
              <br /> Если вы хотите подключить кассу c ФФД 1.2, обратитесь,
              пожалуйста, в нашу службу поддержки. Также предлагаем вам
              подключить наше бесплатное решение по 54-ФЗ: Юнит.Чеки
            </span>
          </ModalAlert>
          ...
          <div className="w-full max-w-full flex flex-col">
            <Input
              label="Идентификатор места расчётов"
              className="w-full max-w-full"
            />
            <span className="text-[10px] text-[#99A1B7] tracking-tight">
              Формат: xxxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
            </span>
          </div>

          <div className="flex gap-6 flex-wrap">
            <div className="grow-1 basis-[200px] w-full flex flex-col ">
              <Input label="Ваш логин в МодульКасса" className=" w-full" />
              <span className="text-[10px] text-[#99A1B7] tracking-tight">
                от выбранной кассы
              </span>
            </div>
            <div className="grow-1 basis-[200px] w-full flex flex-col ">
              <Input
                label="Ваш пароль в МодульКасса"
                className="w-full"
