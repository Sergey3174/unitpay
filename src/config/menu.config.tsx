...
export const MENU_SIDEBAR: MenuConfig = [
  {
    title: 'Главная',
    icon: () => <KeenIcon icon="home" />,
    path: '/',
  },
  {
    title: 'Транзакции',
    icon: () => <KeenIcon icon="arrow-mix" style="duotone" />,
    path: '/transaction',
  },
  {
    title: 'Статистика',
    icon: () => <KeenIcon icon="chart-pie-4" />,
    path: '/statistic',
  },
  {
    title: 'Отчёты',
    icon: () => <KeenIcon icon="document" />,
    path: '/reports',
  },
  {
    title: 'Выплаты',
    icon: () => <KeenIcon icon="cheque" />,
    path: '/payments',
  },
  {
    title: 'Проекты',
    icon: () => <KeenIcon icon="book-square" />,
    path: '/projects',
  },

  {
    title: 'Кассы',
    icon: () => <KeenIcon icon="calculator" />,
    path: '/box-office',
  },

  {
    title: 'Документы',
    icon: () => <KeenIcon icon="tablet-text-up" />,
    path: '/projects',
  },
  {
    title: 'Пользователи',
  ...
  {
    title: 'Диспуты',
    icon: () => <KeenIcon icon="arrow-circle-left" />,
    path: '/disputes',
  },
  {
  ...
  {
    title: 'Ответы на диспуты',
    icon: () => <KeenIcon icon="arrow-circle-left" />,
    path: '/response-disputes',
  },
  {
    title: 'Блог',
    icon: () => <KeenIcon icon="book" />,
    path: '/blog',
  },
  {
    title: 'Сотрудничество',
    icon: () => <KeenIcon icon="security-user" />,
    path: '/projects',
  },
  {
    title: 'Выставить счет',
    icon: () => <KeenIcon icon="tablet-ok" />,
    path: '/projects',
  },
];
